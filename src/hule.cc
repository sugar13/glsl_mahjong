...
const GLuint TILE_1S = 0x21; // 一索 🀐
const GLuint TILE_2S = 0x22; // 二索 🀑
const GLuint TILE_3S = 0x23; // 三索 🀒
const GLuint TILE_4S = 0x24; // 四索 🀓
const GLuint TILE_5S = 0x25; // 五索 🀔
const GLuint TILE_6S = 0x26; // 六索 🀕
const GLuint TILE_7S = 0x27; // 七索 🀖
const GLuint TILE_8S = 0x28; // 八索 🀗
const GLuint TILE_9S = 0x29; // 九索 🀘

const GLuint TILE_1P = 0x31; // 一筒 🀙
const GLuint TILE_2P = 0x32; // 二筒 🀚
const GLuint TILE_3P = 0x33; // 三筒 🀛
const GLuint TILE_4P = 0x34; // 四筒 🀜
const GLuint TILE_5P = 0x35; // 五筒 🀝
const GLuint TILE_6P = 0x36; // 六筒 🀞
const GLuint TILE_7P = 0x37; // 七筒 🀟
const GLuint TILE_8P = 0x38; // 八筒 🀠
const GLuint TILE_9P = 0x39; // 九筒 🀡
